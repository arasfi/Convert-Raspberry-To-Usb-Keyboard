...
socket.addEventListener('close', (event) => onSocketDisconnect(event.reason));
socket.addEventListener('error', (event) => onSocketDisconnect(event.reason));
socket.addEventListener('keydown-received', (data) => {
